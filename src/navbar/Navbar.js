...
const Navbar = () => {
    ...
    return (
        <nav className="w-full bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between py-4 text-xl text-white font-bold">

                    {/* logo */}
                    <div>
                        <button>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 text-black-600" viewBox="0 0 24 24">
                    ...
                    {/* Horizontal list */}
                    <div className="hidden md:flex md:items-center space-x-14">
                        <NavLink className="hover:text-slate-600 mr-4" to={""}>Home</NavLink>
                        <NavLink className="hover:text-slate-600 mr-4" to={"/learnwithme"}>Learn With Me</NavLink>
                        <NavLink className="hover:text-slate-600 mr-4" to={"/mywork"}>My Work</NavLink>
                        <NavLink className="hover:text-slate-600 mr-4" to={"/myproject"}>Project</NavLink>
                        <NavLink className="hover:text-slate-600 mr-4" to={"/contact"}>Contact</NavLink>
                    </div>

                    {/* button */}
                    <div class="md:hidden">
                        <button ref={ref} onClick={handleClick}>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-black-600" viewBox="0 0 24 24">
                ...
                {/* Drop list */}
                <div className={`${openDropdown ? "block" : "hidden"} md:hidden bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 border-t-2 py-2"`}>
                    <div class="flex flex-col items-center text-sm text-white font-bold">
                        <NavLink className="hover:text-slate-600 mb-1" to={""}>Home</NavLink>
                        <NavLink className="hover:text-slate-600 mb-1" to={"/learnwithme"}>Learn With Me</NavLink>
                        <NavLink className="hover:text-slate-600 mb-1" to={"/mywork"}>My Work</NavLink>
                        <NavLink className="hover:text-slate-600 mb-1" to={"/myproject"}>Project</NavLink>
                        <NavLink className="hover:text-slate-600 mb-1" to={"/contact"}>Contact</NavLink>
                    </div>
                </div>
